...
public class Setting {
    ...
    final public static String CLIENT_BASE_URL = "http://localhost:8084";
    ...
    final public static String SERVER_USER_URL = "http://localhost:8081";
    final public static String SERVER_CATALOG_URL = "http://localhost:8082";
    final public static String SERVER_ORDER_URL = "http://localhost:8083";
    final public static String SERVER_IMAGE_URL = "http://localhost:8082/api/image/";
}
